...
const TOKEN_NAME: string = "AONEA COIN";
const TOKEN_SYMBOL: string = "A1A";
const TOTAL_SUPPLY: string = "1000000000000000000000000000";

describe(TOKEN_SYMBOL + " Token Test", function () {
    let contract: A1A;
    let supervisorContract: A1A;
    let ordinaryContract: A1A;
    let freezedContract: A1A;
    let burnerContract: A1A;
    let lockerContract: A1A;
    let timeLocked1Contract: A1A;
    let timeLocked2Contract: A1A;
